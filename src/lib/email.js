...
// Credit alert email
export async function sendCreditAlertEmail({ to, name, remainingCredits, planName }) {
    const html = `
    <!DOCTYPE html>
    <html>
      <head>
...
export async function sendSubscriptionUpdateEmail({ to, name, planName, status, nextBillingDate }) {
