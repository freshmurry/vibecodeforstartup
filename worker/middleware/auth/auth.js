...
var logger = (0, logger_1.createLogger)('AuthMiddleware');
/**
    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            try {
                ...
                return [2 /*return*/, authService.validateTokenAndGetUser(token, env)];
            }
            catch (error) {
 ...
 * Authentication middleware
 */
function authMiddleware(request, env) {
    return __awaiter(this, void 0, void 0, function () {
        var token, userResponse, error_1;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 3, , 4]);
                    token = (0, authUtils_1.extractToken)(request);
                    if (!token) return [3 /*break*/, 2];
                    return [4 /*yield*/, validateToken(token, env)];
                case 1:
                ...
                case 3:
                    error_1 = _a.sent();
                    logger.error('Auth middleware error', error_1);
                    return [2 /*return*/, null];
