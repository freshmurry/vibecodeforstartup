...
var DatabaseService = /** @class */ (function () {
    function DatabaseService(env) {
        var instrumented = Sentry.instrumentD1WithSentry(env.DB);
        this.db = (0, d1_1.drizzle)(instrumented, { schema: schema });
    }
    // ========================================
    // UTILITY METHODS
    // ========================================
    DatabaseService.prototype.getHealthStatus = function () {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        return [4 /*yield*/, this.db.select().from(schema.systemSettings).limit(1)];
                    case 1:
                        _a.sent();
                        return [2 /*return*/, {
                                healthy: true,
