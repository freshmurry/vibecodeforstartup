...
exports.createGitHubHeaders = createGitHubHeaders;
exports.extractGitHubErrorText = extractGitHubErrorText;
/**
 ...
 */
function extractGitHubErrorText(response) {
    return __awaiter(this, void 0, void 0, function () {
        var contentType, errorData, errorText, parseError_1;
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    errorData = (_a.sent());
                    return [2 /*return*/, (errorData.message ||
                            errorData.error ||
                            "HTTP ".concat(response.status))];
                case 2: return [4 /*yield*/, response.text()];
                case 3:
                    errorText = _a.sent();
                    return [2 /*return*/, errorText || "HTTP ".concat(response.status)];
                case 4: return [3 /*break*/, 6];
                case 5:
                    parseError_1 = _a.sent();
                    // If parsing fails, return generic error
                    return [2 /*return*/, "HTTP ".concat(response.status)];
