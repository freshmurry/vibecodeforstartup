...
exports.getTemplatesData = getTemplatesData;
exports.getBYOKTemplates = getBYOKTemplates;
 ...
 */
function getBYOKTemplates() {
    return getTemplatesData().filter(function (template) { return template.category === 'byok'; });
}
