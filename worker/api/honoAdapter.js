...
function adaptController(controller, method) {
    var _this = this;
    return function (c) { return __awaiter(_this, void 0, void 0, function () {
        var authResult, routeContext;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, (0, routeAuth_1.enforceAuthRequirement)(c)];
                case 1:
                    authResult = _a.sent();
                    if (authResult) {
                    ...
                    return [4 /*yield*/, method.call(controller, c.req.raw, c.env, c.executionCtx, routeContext)];
