...
export type WebSocketMessage = StateMessage | GenerationStartedMessage | FileGeneratingMessage | FileRegeneratingMessage | FileChunkGeneratedMessage | FileGeneratedMessage | FileRegeneratedMessage | GenerationCompleteMessage | DeploymentStartedMessage | DeploymentCompletedMessage | DeploymentFailedMessage | CodeReviewingMessage | CodeReviewedMessage | CommandExecutingMessage | RuntimeErrorFoundMessage | CodeFixEdits | StaticAnalysisResults | PhaseGeneratingMessage | PhaseGeneratedMessage | PhaseImplementingMessage | PhaseImplementedMessage | PhaseValidatingMessage | PhaseValidatedMessage | GenerationStoppedMessage | GenerationResumedMessage | CloudflareDeploymentStartedMessage | CloudflareDeploymentCompletedMessage | CloudflareDeploymentErrorMessage | ScreenshotCaptureStartedMessage | ScreenshotCaptureSuccessMessage | ScreenshotCaptureErrorMessage | ScreenshotAnalysisResultMessage | GitHubExportStartedMessage | GitHubExportProgressMessage | GitHubExportCompletedMessage | GitHubExportErrorMessage | ErrorMessage | RateLimitErrorMessage | UserSuggestionsProcessingMessage | ConversationResponseMessage | DeterministicCodeFixStartedMessage | DeterministicCodeFixCompletedMessage | ModelConfigsInfoMessage | TerminalCommandMessage | TerminalOutputMessage | ServerLogMessage;
