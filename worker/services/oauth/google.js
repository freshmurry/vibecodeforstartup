...
var logger = (0, logger_1.createLogger)('GoogleOAuth');
/**
 * Google OAuth Provider implementation
 */
var GoogleOAuthProvider = /** @class */ (function (_super) {
    __extends(GoogleOAuthProvider, _super);
    function GoogleOAuthProvider() {
        var _this = _super !== null && _super.apply(this, arguments) || this;
        _this.provider = 'google';
        _this.authorizationUrl = 'https://accounts.google.com/o/oauth2/v2/auth';
        _this.tokenUrl = 'https://oauth2.googleapis.com/token';
        _this.userInfoUrl = 'https://www.googleapis.com/oauth2/v2/userinfo';
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        ...
                        throw new Error("Failed to get user info: ".concat(error));
     ...
     */
    GoogleOAuthProvider.create = function (env, baseUrl) {
        if (!env.GOOGLE_CLIENT_ID || !env.GOOGLE_CLIENT_SECRET) {
            throw new Error('Google OAuth credentials not configured');
        }
        var redirectUri = "".concat(baseUrl, "/api/auth/callback/google");
